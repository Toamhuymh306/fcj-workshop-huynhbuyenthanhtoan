...
# AMAZON EKS AUTO MODE & ISTIO AMBIENT MESH - GIẢI PHÁP BETTER TOGETHER CHO MICROSERVICES
...
## Amazon EKS Auto Mode - Tự động hóa hạ tầng Kubernetes
...
## Istio Ambient Mesh - Bảo mật và quản lý traffic không cần sidecar
...
## Lợi ích khi kết hợp EKS Auto Mode và Istio Ambient Mesh
