...
![Create bucket](/fcj-workshop-huynhbuyenthanhtoan/images/5-Workshop/5.3-S3-vpc/create-bucket.png)

3. Trong Create bucket console
+ Đặt tên bucket: chọn 1 tên mà không bị trùng trong phạm vi toàn cầu (gợi ý: lab\<số-lab\>\<tên-bạn\>)

![Bucket name](/fcj-workshop-huynhbuyenthanhtoan/images/5-Workshop/5.3-S3-vpc/bucket-name.png)


+ Giữ nguyên giá trị của các fields khác (default)
+ Kéo chuột xuống và chọn **Create bucket**

![Create](/fcj-workshop-huynhbuyenthanhtoan/images/5-Workshop/5.3-S3-vpc/create-button.png)    

+ Tạo thành công S3 bucket

![Success](/fcj-workshop-huynhbuyenthanhtoan/images/5-Workshop/5.3-S3-vpc/bucket-success.png)
...
![system manager](/fcj-workshop-huynhbuyenthanhtoan/images/5-Workshop/5.3-S3-vpc/sm.png)

2. Từ **Systems Manager** menu, tìm **Node Management** ở thanh bên trái và chọn **Session Manager**:

![system manager](/fcj-workshop-huynhbuyenthanhtoan/images/5-Workshop/5.3-S3-vpc/sm1.png)
...
![Start session](/fcj-workshop-huynhbuyenthanhtoan/images/5-Workshop/5.3-S3-vpc/start-session.png)

Session Manager sẽ mở browser tab mới với shell prompt: sh-4.2 $

![Success](/fcj-workshop-huynhbuyenthanhtoan/images/5-Workshop/5.3-S3-vpc/start-session-success.png)
...
![Change user's dir](/fcj-workshop-huynhbuyenthanhtoan/images/5-Workshop/5.3-S3-vpc/cli1.png)

2. Tạo 1 file để kiểm tra bằng lệnh "fallocate -l 1G testfile.xyz", 1 file tên "testfile.xyz" có kích thước 1GB sẽ được tạo.

![Create file](/fcj-workshop-huynhbuyenthanhtoan/images/5-Workshop/5.3-S3-vpc/cli-file.png)
...
![Uploaded](/fcj-workshop-huynhbuyenthanhtoan/images/5-Workshop/5.3-S3-vpc/uploaded.png)
...
![Check S3](/fcj-workshop-huynhbuyenthanhtoan/images/5-Workshop/5.3-S3-vpc/check-s3-bucket.png)
